...
The next managed-pilot gates are verified outbound email with an idempotent outbox, backup restoration rehearsal, remaining product-copy review, and the commercial offer/customer agreement. Self-service billing remains deferred for the managed-workspace release. Production resources and secrets remain unchanged.
